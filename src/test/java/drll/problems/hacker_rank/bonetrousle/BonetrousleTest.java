...
class BonetrousleTest {
    ...
    @Test
    void should_respond_correctly_for_test_case_1_of_hr() {
        int sticksToBuy = 12;
        int boxesForSale = 8;
    ...
    @Test
    void should_respond_correctly_for_test_case_2_of_hr() {
        int sticksToBuy = 10;
        int boxesForSale = 3;
        int numberOfBoxesToBuy = 3;
    ...
    @Test
    void should_respond_correctly_for_test_case_3_of_hr() {
        int sticksToBuy = 9;
        int boxesForSale = 10;
    ...
    @Test
    void should_return_NA_when_buy_7_sticks_in_4_boxes_and_exist_10_boxes() {
        int sticksToBuy = 7;
        int boxesForSale = 10;
    ...
    @Test
    void should_return_accepted_combination_when_buy_10_sticks_in_4_boxes_and_exist_10_boxes() {
        int sticksToBuy = 10;
        int boxesForSale = 10;
        int numberOfBoxesToBuy = 4;
    ...
    @Test
    void should_return_accepted_combination_when_buy_10_sticks_in_2_boxes_and_exist_10_boxes() {
        int sticksToBuy = 10;
        int boxesForSale = 10;
        int numberOfBoxesToBuy = 2;
    ...
    @Test
    void should_return_NA_when_buy_10_sticks_in_1_boxes_and_exist_4_boxes() {
        int sticksToBuy = 10;
        int boxesForSale = 4;
    ...
    @Test
    void should_return_accepted_combination_when_buy_4_sticks_in_1_boxes_and_exist_4_boxes() {
        int sticksToBuy = 4;
        int boxesForSale = 4;
        int numberOfBoxesToBuy = 1;
